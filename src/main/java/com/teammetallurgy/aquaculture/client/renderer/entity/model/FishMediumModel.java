...
public class FishMediumModel<T extends Entity> extends SegmentedModel<T> { //Based on Cod
    ...
    public FishMediumModel() {
        ...
        this.head.func_228301_a_(-1.0F, -2.0F, -3.0F, 2, 4, 3, 0.0F);
        ...
        this.finRight.func_228301_a_(-2.0F, 0.0F, -1.0F, 2, 0, 2, 0.0F);
        ...
        this.finLeft.func_228301_a_(0.0F, 0.0F, -1.0F, 2, 0, 2, 0.0F);
        ...
        this.finTop.func_228301_a_(0.0F, -1.0F, -1.0F, 0, 2, 6, 0.0F);
        this.bottomFin = new ModelRenderer(this, 20, 5);
        this.bottomFin.setRotationPoint(0.0F, 25.0F, 0.0F);
        this.bottomFin.func_228301_a_(0.0F, -1.0F, -1.0F, 0, 2, 6, 0.0F);
    }
