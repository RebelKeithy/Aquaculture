...
public class FishCathfishModel<T extends Entity> extends SegmentedModel<T> { //Based on Cod
    ...
    public FishCathfishModel() {
        ...
        this.leftFin = new ModelRenderer(this, 26, 2);
        this.leftFin.setRotationPoint(1.0F, 21.9F, 1.5F);
