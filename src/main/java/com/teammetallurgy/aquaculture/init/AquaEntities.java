...
public class AquaEntities {
    public static final EntityType<AquaFishingBobberEntity> FISH_HOOK = register("bobber", EntityType.Builder.<AquaFishingBobberEntity>create(EntityClassification.MISC)
