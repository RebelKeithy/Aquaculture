...
public class Hooks {
    ...
    public static final Hook NETHER_STAR = new Hook.HookBuilder("nether_star").setColor(TextFormatting.BLACK).setFluid(FluidTags.LAVA).setDurabilityChance(0.50).setLuckModifier(1).build();
