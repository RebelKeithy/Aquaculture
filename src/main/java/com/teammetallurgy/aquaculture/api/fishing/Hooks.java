...
public class Hooks {
    ...
    public static final Hook NOTE = new Hook.HookBuilder("note").setColor(TextFormatting.YELLOW).build();
    public static final Hook RED = new Hook.HookBuilder("red").setColor(TextFormatting.RED).build();
}